                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            Supine: Where Less is More.
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">Supinism, the philosophy of embracing rest and relaxation, is more than just a trend—it's a lifestyle. In a world that constantly pushes for productivity and hustle, Supinism offers a refreshing counter-approach: the art of doing nothing. By prioritizing rest, we can achieve a balanced, healthier, and more fulfilling life.</div>
