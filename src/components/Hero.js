    ...
    return (
        <>
            <div className="hero" id='hero'>
                ...
                <div className="m-auto max-w-6xl mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">

                    <div className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center" data-aos="zoom-in-right" data-aos-delay="200">
                            <h1 className="mb-5 md:text-5xl text-3xl font-bold text-blue-900">We build digital solutions to help businesses scale</h1>
                            ...
                            <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                                <a href="#_" className="text-white bg-blue-900 hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0">
                                    Get Started
                        ...
                        <div className="flex lg:justify-end w-full lg:w-1/2" data-aos="fade-left" data-aos-delay="700">
