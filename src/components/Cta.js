...
const Cta = () => {
    return ( 
        <div className="w-full h-auto flex items-center justify-center text-white cta">
            <div className="mx-8 w-full text-center lg:text-left py-16 px-12 flex flex-col">                    
                <div className="flex flex-col lg:flex-row lg:justify-between">
                    ...
                    <div className="w-full lg:w-72 pt-6 lg:mx-12">
                        ...
                        <svg className="w-5 h-5 ml-1 group-hover:translate-x-2 duration-500 ease-in" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </Link>
                    </div>
                </div>
            </div>
