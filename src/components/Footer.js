                ...
                <div className="mx-5 w-full text-center lg:text-left py-16 px-12 flex flex-col">                    
                    ...
                    <div className="flex flex-col">
                        <div className="flex mt-24 mb-12 flex-row justify-between">
                            ...
                            <a className="hidden md:block cursor-pointer text-gray-600 hover:text-blue-900 uppercase">About</a>
                            <a className="hidden md:block cursor-pointer text-gray-600 hover:text-blue-900 uppercase">Services</a>
                            <a className="hidden md:block cursor-pointer text-gray-600 hover:text-blue-900 uppercase">Why us</a>
                            <a className="hidden md:block cursor-pointer text-gray-600 hover:text-blue-900 uppercase">Contact</a>
